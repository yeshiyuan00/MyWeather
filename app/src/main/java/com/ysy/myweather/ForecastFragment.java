    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                Log.v("URL PATH =", builtUri.toString());
        ...
        protected void onPostExecute(String[] results) {
            if (results != null) {
                mForcecastAdapter.clear();
                for (String dayForecastStr : results) {
                    mForcecastAdapter.add(dayForecastStr);
                }
            }
        }
        ...
        private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays)
            ...
            int julianStartDay = dayTime.getJulianDay(System.currentTimeMillis(), dayTime.gmtoff);
